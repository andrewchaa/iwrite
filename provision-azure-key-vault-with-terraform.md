# Provision Azure Key Vault with Terraform

Recently, I was tasked to encrypt Users' API token and store them in the database. For the encryption, I created a symmetric key and IV \(Initialization Vector\), and wanted to store them in Azure Key Vault secrets. So, I provision it with Terraform. 
